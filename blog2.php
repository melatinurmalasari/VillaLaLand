      ...
      <div class="container">
        <div class="row">
          <div class="col mt-5 pt-4">
            <p>
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Totam nulla quisquam inventore fugit
            ...
            <div class="row mt-4 mb-4">
              ...
              <div class="col-sm-12 col-md-10">
                <div class="col-sm-12 col-md-9 d-flex justify-content-center align-items-start flex-column">
                  <h5>Bessie Cooper</h5>
                  <p>8 minutes ago</p>
                  <p>
                    I am truly humbled by your clear love of the country, its democracy, and its people in the face of
                    such irrational and uncalled for hatred. Please know that there are literally millions of Americans
                    that stand with you and share your hopes and dreams. Gus and Penelope are very lucky indeed.
                  </p>
                  <input type="text" class="bg-secondary bg-opacity-25 form-control" placeholder="Reply">
                </div>
              </div>
            </div>
            <div class="row mb-4">
